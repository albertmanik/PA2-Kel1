                    ...
                    <div class="ltn__breadcrumb-inner text-center">
                        ...
                        <div class="ltn__breadcrumb-list">
                            <ul>
                                ...
                                <li><a href="{{ route('bouquet.index') }}">Bouquet</li></a>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="modal-product-info shop-details-info pl-0">
                                    ...
                                    <div class="product-price-ratting mb-20">
                                        <ul>
                                            ...
                                            @php
                                                $rating = \App\Models\Review::where('product_id', $bouquet->id)->avg('rating');
                                    ...
                                    {{-- <div class="ltn__safe-checkout d-none">
                                        ...
                                        <img src="{{ asset('papanbunga/' . $bouquet->gambar) }}"
                                            alt="Payment Image">
                                    </div> --}}
                                </div>
                            </div>
                                            ...
                                            <div class="ltn__comment-area mb-30">
                                                <div class="ltn__comment-inner">
                                                                ...
                                                                <li>
                                                                    <div class="ltn__comment-item clearfix">
                                                                        ...
                                                                        <div class="ltn__commenter-comment">
                                                                            ...
                                                                            <p>{{ $item->review }}</p>
                                                                            <span
                                                                                class="ltn__comment-reply-btn">{{ $item->created_at->format('d/m/Y H:i:s') }}</span>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            @endif
                                                    ...
                                                    {{-- <div class="showing-product-number text-right">
                                                        <span>Showing {{ $review->firstItem() }} to
                                                            {{ $review->lastItem() }} of
