                ...
                <div class="col-lg-12">
                    <div class="ltn__checkout-inner">
                        <div class="ltn__checkout-single-content mt-50">
                            <h4 class="title-2">Informasi Pembayaran</h4>
                            <div class="ltn__checkout-single-content-info">
                                ...
                                <form action="{{ route('checkout.update', $checkout->id) }}" method="POST"
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-item input-item-website ltn__custom-icon">
                                                <input type="text" name="alamat"
                                                    ...
                                                    value="{{ $checkout->alamat }}" placeholder="Masukkan Lokasi Kirim">
                                                @error('alamat')
                                                    <div class="invalid-feedback mb-4" style="margin-top: -2%">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="input-item input-item-textarea ltn__custom-icon">
                                        <textarea class="form-control @error('ucapan') is-invalid @enderror" name="ucapan" placeholder="Masukkan Ucapan">{{ old('ucapan', $checkout->ucapan) }}</textarea>
                                        @error('ucapan')
                                            <div class="invalid-feedback mb-4" style="margin-top: -2%">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="ltn__checkout-payment-method mt-50">
                                                ...
                                                <input type="file" name="image"
                                                    ...
                                                    class="form-control @error('image') is-invalid @enderror">{{ $checkout->image }}
                                                @error('image')
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><strong>Rp.
                                            {{ number_format(old('total', $checkout->total), 2, ',', '.') }}</strong>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
